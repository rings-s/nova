"""create tenants and branches

Revision ID: 82b108bd4e78
Revises: 
Create Date: 2026-08-13 20:58:49.062006
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('tenant_id', 'slug', name=op.f('uq_branches_tenant_id'))
    )
