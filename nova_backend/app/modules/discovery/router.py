    ...
    return Page(
        items=[
            ListingCardOut(
                ...
                logo_asset_id=card.business.logo_asset_id,
                cover_asset_id=card.business.cover_asset_id,
...
async def get_storefront(
    ...
    return StorefrontOut(
        ...
        logo_asset_id=business.logo_asset_id,
        cover_asset_id=business.cover_asset_id,
